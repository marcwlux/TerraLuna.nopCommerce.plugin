...
namespace Nop.Plugin.Payments.TerraLuna.Components
{
    public class PaymentTerraLunaViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.TerraLuna/Views/PaymentInfo.cshtml", model);
        }
    }
}
